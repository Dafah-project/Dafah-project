    ...
    render() {
        return(
          ...
          <Carousel.Item interval={2000}>
              ...
              />
              <div className = "carousel-caption" style = {{padding:"10rem"}}>
                  <h1 className="text-light bg-dark" style = {{opacity:"40%"}}>DAFAH</h1>
                  <p className = "lead text-light bg-dark" style = {{opacity:"40%"}}>"You give but little when you give of your possessions.
                  It is when you give of yourself that you truly give."</p>
                  <br />
                  <p className = "lead text-light bg-dark" style = {{opacity:"40%"}}>-Khalil Jubran</p>
                  <div className = "btn btn-primary">Add Item</div>
              </div>
          </Carousel.Item>
          <Carousel.Item interval={2000}>
